...
if __name__ == "__main__":
    ...
    config = yaml_config_hook("config_inp.yaml")
    ...
    C, R =  dualsc_with_zero(x, alpha = 0.0001, beta = 0.0000001, rho=1, max_iter=100)
    y_pred = cal_sp_sc(C, dataset.association_mat, 0.8, dataset.n_classes)
