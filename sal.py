...
if __name__ == "__main__":
    ...
    config = yaml_config_hook("config_sal.yaml")
    ...
    C, R =  dualsc_with_zero(x, alpha = 0.001, beta = 0.01, rho=1, max_iter=100)
    y_pred = cal_sp_sc(C, dataset.association_mat, 1, dataset.n_classes)
